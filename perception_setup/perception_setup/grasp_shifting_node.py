...
class GraspShiftingNode(Node):
    def __init__(self):
        ...
        # Matches Gazebo wide_angle_camera (f=190.68)
        self.fx = 190.68
        self.fy = 190.68
        self.cx = 320.0
        self.cy = 240.0
        ...
        # Distortion is 0 in Sim, but needed for the undistort function
        self.D = np.zeros(4) 
        ...
        self.get_logger().info(f"Grasp Shifter Online (Hardcoded Intrinsics).")
